...
| `Game_ForceTemporarilySavingData` | `false` | `true` | `true` | `false` | Controls if all save data that would normally be saved without an expiration date is forced to be temporarily saved. This flag is ineffective in the main build. |
