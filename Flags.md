...
| `Game_ForceTemporarilySavingData` | `false` | `true` | `true` | `false` | All save data that would normally be permanently saved is forced to be temporarily saved. This flag is ineffective in the main build. |
