...
| `Game_ForcedTemporarilySavedDataExpiration` | `86100` |  |  | `60` | Controls how long until data that is usually saved without an expiration date gets automatically removed when it is forced to be temporary. |
